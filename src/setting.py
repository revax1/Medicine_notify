...
class Ui_setting(object):
    def setupUi(self, setting):
        ...
        self.ab_checkBox.setGeometry(QtCore.QRect(370, 250, 61, 71))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.bl2_checkBox = QtWidgets.QCheckBox(self.centralwidget)
        self.bl2_checkBox.setGeometry(QtCore.QRect(200, 160, 61, 71))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.bl2_checkBox.sizePolicy().hasHeightForWidth())
        self.bl2_checkBox.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(14)
        self.bl2_checkBox.setFont(font)
        self.bl2_checkBox.setFocusPolicy(QtCore.Qt.WheelFocus)
        self.bl2_checkBox.setText("")
        self.bl2_checkBox.setTristate(False)
        self.bl2_checkBox.setObjectName("bl2_checkBox")
        self.ad_checkBox = QtWidgets.QCheckBox(self.centralwidget)
        self.ad_checkBox.setGeometry(QtCore.QRect(20, 240, 61, 71))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.a_label.setGeometry(QtCore.QRect(210, 100, 131, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_3.setGeometry(QtCore.QRect(370, 100, 131, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
...
"background-color: rgb(166, 0, 0)")
        ...
        self.bl2_checkBox.clicked['bool'].connect(self.bl_cr_label.setEnabled) # type: ignore
