...
"background-color: rgb(244, 212, 99);")
        ...
        self.next_pushButton.setGeometry(QtCore.QRect(int(540 * width), int(80 * height), int(100 * width), int(31 * height)))
        font = QtGui.QFont()
        font.setPointSize(int(12 * height))
...
#         self.frame_2.setObjectName("frame_2")
    ...
    def retranslateUi(self, sortDrug):
        ...
        self.next_pushButton.setText(_translate("prepare", "เริ่มจัดเตรียมยา"))
